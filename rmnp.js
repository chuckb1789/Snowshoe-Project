...
function snowFunction($http) {
  ...
  snowCtrl.title = 'Project Snowshoe'
    ...
    snowCtrl.getWeather = function () {
     var url =window.location.protocol+'//'+window.location.host+'/forecast/40.3292,-105.5933'
    ...
    //  snowCtrl.getSnow = function () {
        ...
        // var url = 'https://api.weatherunlocked.com/api/snowreport/303011?app_id='+ID+'&app_key='+APIKEY2
