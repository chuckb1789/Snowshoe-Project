...
function snowFunction($http) {
  ...
  snowCtrl.title = 'Project Snowshoe'
   ...
   var url =window.location.protocol+'//'+window.location.host+'/forecast/39.7292,-105.9047'
   ...
   $http.get(url)
    ...
    //  snowCtrl.getSnow = function () {
        ...
        // var url = 'https://api.weatherunlocked.com/api/snowreport/303014?app_id='+ID+'&app_key='+APIKEY2
